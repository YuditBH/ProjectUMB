...
namespace UProject.Controllers
{
    public class ContactSurfaceController:SurfaceController
    {
        ...
        {
            ContactViewModul model = new ContactViewModul()
            {
        ...
        [HttpPost]
        public ActionResult RenderForm(ContactViewModul model)
        {
            return PartialView("~/Views/Partials/Contact/contactForm.cshtml", model);
        }
        [HttpPost]
        public ActionResult SubmitForm(ContactViewModul model)
        {
            bool success = false;
        ...
        private void SendContactFormReceivedEmail(ContactViewModul model)
        {
            var siteSettings = Umbraco.ContentAtRoot().DescendantsOrSelfOfType("settings").FirstOrDefault();
            if (siteSettings == null)
            {
